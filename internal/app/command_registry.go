		...
		Children: []*commandSpec{
			...
			},
			{
				...
				Children: []*commandSpec{
					...
					{Name: "exec", Summary: "Run a local command as a bounded run attempt", Usage: "tok run exec --task <task-id> [--limit <n>] [--timeout <duration>] [--limit-bytes <n>] [--allow-active] [--allow-dangerous] [--json] -- <command...>", Flags: []flagSpec{
						{Name: "--task", ValueName: "<task-id>", Summary: "Task id"},
						{Name: "--limit", ValueName: "<n>", Summary: "Maximum retrieval result count"},
						{Name: "--timeout", ValueName: "<duration>", Summary: "Execution timeout"},
					...
					{Name: "record-artifact", Summary: "Attach file evidence to a run", Usage: "tok run record-artifact <run-id> --kind <kind> --input <path|-> [--limit-bytes <n>] [--json]", Flags: []flagSpec{
						{Name: "--kind", ValueName: "<kind>", Summary: "Artifact kind", ValueChoices: []string{"stdout", "stderr", "log", "patch"}},
						{Name: "--input", ValueName: "<path|->", Summary: "Input file path or stdin"},
						{Name: "--limit-bytes", ValueName: "<n>", Summary: "Maximum bytes to store"},
						{Name: "--json", Summary: "Print JSON output"},
					}},
					{Name: "validate", Summary: "Run validation command and attach evidence", Usage: "tok run validate <run-id> [--timeout <duration>] [--limit-bytes <n>] [--allow-dangerous] [--json] -- <command...>", Flags: []flagSpec{
						{Name: "--timeout", ValueName: "<duration>", Summary: "Validation timeout"},
						{Name: "--limit-bytes", ValueName: "<n>", Summary: "Maximum stdout/stderr bytes to store"},
						{Name: "--allow-dangerous", Summary: "Allow commands rejected by the safety policy"},
						{Name: "--json", Summary: "Print JSON output"},
					}},
